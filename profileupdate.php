<?php
	...
	{					
		...
		function profileupdate($params, $tpl)
		{
			extract($params);
			extract($_POST);
        	...
        	*/
			...
			if($rs_serve)
				echo "<center><h2><font color=green> Profile Updated Sucessfully</font></h2></center>";
			else
			    echo "<center><h2><font color=green> Unable to Update Profile</font></h2></center>";
